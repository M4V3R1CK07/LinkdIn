      ...
      <main className="flex flex-col xl:flex-row items-center max-w-screen-xl mx-auto gap-48 px-4 py-10">
        ...
        <div className="space-y-8 xl:space-y-10 flex-1">
          ...
          <div className="space-y-4">
            <div
              className="cursor-pointer border border-gray-300 dark:border-gray-700 rounded-lg px-6 py-6 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-800 transition-all"
              onClick={() => signIn("google", { callbackUrl: "/" })}
            >
